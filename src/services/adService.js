...
export const SAMPLE_ADVERTS = [
  {
    id: 'ad-slot-mega-tech',
    title: 'Apple iPhone 15 Pro & MacBook Air Mega Deals',
    businessName: 'Slot Systems Ikeja',
    businessId: 'slot-ikeja-gadgets',
    category: 'Electronics & Tech',
    badge: 'Admin Spotlight',
    placement: 'hero_banner',
    imageUrl: 'https://images.unsplash.com/photo-1591337676887-a217a6970a8a?w=1200&auto=format&fit=crop',
    flyerUrl: 'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=600&auto=format&fit=crop',
    tagline: '100% genuine Apple devices with official 1-year warranty & free protective case.',
    phone: '+2349062083582',
